...
![](assets/chp-15-image384.png) <!-- width="0.3194444444444444in" height="0.18055555555555555in" -->The file icon \[\]{.index
...
![](assets/chp-15-image995.png) <!-- width="2.8895833333333334in" height="2.097916666666667in" -->The Open... option \[\]{.index
...
![](assets/chp-15-image996.png) <!-- width="2.7243055555555555in" height="1.9777777777777779in" -->The search bar \[\]{.index #search-bar} at
the top can be used to find a project by name or text in the project
notes. So in this example:

![](assets/chp-15-image997.png) <!-- width="2.723611111111111in" height="1.9777777777777779in" -->I was looking for my ice cream \[\]{.index
...
Back to the File menu, the Save menu option \[\]{.index #Save-option}
...
![](assets/chp-15-image998.png) <!-- width="3.236111111111111in" height="2.3493055555555555in" -->The Save as... menu option \[\]{.index
...
The Export summary... option \[\]{.index #Export-project...-option}
...
The Libraries... option \[\]{.index #Libraries...-option} presents a
...
![](assets/chp-15-image1000.png) <!-- width="4.28125in" height="3.2395833333333335in" -->The Costumes... option \[\]{.index
...
Finally, the Undelete sprites... option \[\]{.index
...
![](assets/chp-15-image1003.png) <!-- width="1.4368055555555554in" height="0.7597222222222222in" -->![](assets/chp-15-image1004.png) <!-- width="0.2916666666666667in" height="0.16666666666666666in" -->The cloud icon \[\]{.index #cloud-icon}
...
![](assets/chp-15-image1009.png) <!-- width="1.2479166666666666in" height="2.5833333333333335in" -->![](assets/chp-15-image1010.png) <!-- width="0.2916666666666667in" height="0.16666666666666666in" -->The settings icon \[\]{.index
...
The Fade blocks... option \[\]{.index #Fade-blocks...-option} opens a
...
generated](media/image1022.png) <!-- width="1.229861111111111in" height="0.25972222222222224in" -->The Extension blocks option \[\]{.index
...
![](assets/chp-15-image1023.png) <!-- width="1.104861111111111in" height="2.0833333333333335in" -->![](assets/chp-15-image1024.png) <!-- width="1.6388888888888888in" height="0.4131944444444444in" -->Input sliders \[\]{.index
...
![](assets/chp-15-image1029.png) <!-- width="0.36in" height="0.16in" --> and ![A picture
...
![](assets/chp-15-image1033.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->![](assets/chp-15-image1034.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->![](assets/chp-15-image1035.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->![](assets/chp-15-image1036.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->Still in the tool bar, but \[\]{.index
...
#presentation-mode-button} normally looks like this: Clicking the button
...
![](assets/chp-15-image1046.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->![](assets/chp-15-image1047.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->The pause button \[\]{.index
...
![](assets/chp-15-image1051.png) <!-- width="0.8611111111111112in" height="0.45902777777777776in" -->Most elements \[\]{.index
...
The export block definition... option \[\]{.index
...
![](assets/chp-15-image1058.png) <!-- width="0.9895833333333334in" height="0.5895833333333333in" -->Right-click/control-click on \[\]{.index
#context-menu-for-the-palette-background} the grey *background* of the
palette area shows this menu:

![Graphical user interface, text, application, chat or text message
Description automatically generated](media/image1059.png) <!-- width="1.6in" height="2.1597222222222223in" -->The find blocks... option \[\]{.index
...
![Graphical user interface, text, application, chat or text message
Description automatically generated](media/image1062.png) <!-- width="1.35in" height="1.8395833333333333in" -->This example comes from Eckart \[\]{.index
...
Not every reporter has a compile option \[\]{.index
...
What's new here is the result pic... option \[\]{.index
...
![](assets/chp-15-image1075.png) <!-- width="1.2895833333333333in" height="1.2777777777777777in" -->Control-click/right-click on \[\]{.index
...
![](assets/chp-15-image1078.png) <!-- width="1.3888888888888888in" height="0.7083333333333334in" -->The add comment option \[\]{.index
...
![](assets/chp-15-image1082.png) <!-- width="1.9631944444444445in" height="2.1319444444444446in" -->If you click \[\]{.index #Costumes-tab} on
the word "Costumes" under the sprite controls, you'll see something like
this:

![Macintosh
HD:Users:bh:Desktop:pix:camera.png](media/image1083.png) <!-- width="0.37916666666666665in" height="0.21666666666666667in" -->![](assets/chp-15-image1084.png) <!-- width="0.2916666666666667in" height="0.16666666666666666in" -->The Turtle costume \[\]{.index
...
The only other non-obvious tool is the rotation point tool \[\]{.index
...
![](assets/chp-15-image1095.png) <!-- width="3.8361111111111112in" height="2.548611111111111in" -->![](assets/chp-15-image1096.png) <!-- width="0.2152777777777778in" height="0.2152777777777778in" -->![](assets/chp-15-image1097.png) <!-- width="0.2152777777777778in" height="0.2152777777777778in" -->![](assets/chp-15-image1098.png) <!-- width="0.2152777777777778in" height="0.2152777777777778in" -->The vector editor \[\]{.index
...
![Macintosh
HD:Users:bh:Desktop:record-button.png](media/image1099.png) <!-- width="0.35in" height="0.2in" -->There is no Sound Editor \[\]{.index
...
The delete option \[\]{.index #delete-option} deletes the sprite. It's
...
![Macintosh
HD:Users:bh:Desktop:pix:move-handle.png](media/image1113.png) <!-- width="0.6527777777777778in" height="0.8888888888888888in" -->The move option \[\]{.index #move-option}
...
![Macintosh
HD:Users:bh:Desktop:pix:pivot-handle.png](media/image1115.png) <!-- width="0.6527777777777778in" height="0.8472222222222222in" -->The pivot option \[\]{.index
...
![](assets/chp-15-image1123.png) <!-- width="0.8215277777777777in" height="0.8472222222222222in" -->The stage's edit option \[\]{.index
...
![](assets/chp-15-image1127.png) <!-- width="0.6770833333333334in" height="1.1090277777777777in" -->The show option \[\]{.index #show-option}
