...
how some Snap<em>!</em> feature extends something familiar in Scratch. It’s
very helpful to have some experience with Scratch before reading this
manual, but not essential.

To run Snap<em>!</em>, open a browser window and
visit [`https://snap.berkeley.edu/snap`](https://snap.berkeley.edu/snap). The Snap<em>!</em> community web site
