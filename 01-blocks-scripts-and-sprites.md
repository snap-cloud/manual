...
Colors are created by the {inline alt="image414.png" width="0.95in"}`images/01-blocks-scripts-and-sprites/image414` block (for direct user selection), the `color from`
to specify a color numerically, or by {inline alt="image413.png" width="1.13333in"}`images/01-blocks-scripts-and-sprites/image413` , which
