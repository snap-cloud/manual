...
To change the appearance of a sprite, paint or import a new *costume* for it. To paint a costume, click on the Costumes tab above the scripting area, and click the paint button. ![](assets/images/image32.png) <!-- {width="28" height="16"} -->
...
clicking in its wardrobe or by using the ![](assets/images/image34.png) <!-- {width="180" height="25"} -->
 or ![](assets/images/image35.png) <!-- {width="90px" height="23px"} --> block in a script. (Every
...
a change in the sprite's pen color. Protip: ![](assets/images/image33.png) <!-- {width="173px" height="27px"} --> switches to the *previous*
