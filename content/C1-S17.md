...
<!--{width="731px" height="210px"} -->


**\\**
![](assets/images/image224.png)
<!--{width="80px" height="20px"} -->
![](assets/images/image225.png)
<!--{width="137px" height="20px"} -->

**report the sprite or mouse position as a two-item
vector (x,y).**

![](assets/images/image226.png)
<!--{width="575px" height="31px"} -->
**First class procedure blocks (see Chapter VI, page**
**65):**

![](assets/images/image240.png)
<!--{width="512px" height="33px"} -->
![](assets/images/image246.png)
...
![](assets/images/image250.png)
<!--{width="565px" height="206px"} -->
...
![](assets/images/image286.png)
<!--{width="718px" height="108px"} -->
...
![](assets/images/image296.png)
<!--{width="247px" height="136px"} -->
...
![](assets/images/image300.png)
<!--{width="232px" height="102px"} -->
...
![](assets/images/image304.png)
<!--{width="102px" height="27px"} -->
![](assets/images/image305.png)
...
![](assets/images/image306.png)
<!--{width="101px" height="27px"} -->
respect to its second input.

![](assets/images/image307.png)
<!--{width="136px" height="320px"} -->
...
![](assets/images/image311.png)
<!--{width="315px" height="53px"} -->


![](assets/images/image313.png)
<!--{width="361px" height="117px"} -->


![](assets/images/image325.png)
<!--{width="213px" height="159px"} -->
...
![](assets/images/image341.png)
<!--{width="363px" height="174px"} -->
![](assets/images/image351.png)
...
![](assets/images/image356.png)
<!--{width="216px" height="40px"} -->
![](assets/images/image357.png)
...
<!--{width="571px" height="84px"} -->
![](assets/images/image366.png)
<!--{width="535px" height="106px"} -->
![](assets/images/image370.png)
<!--{width="611px" height="279px"} -->


![](assets/images/image376.png)
<!--{width="140px" height="223px"} -->
![](assets/images/image380.png)
<!--{width="564px" height="97px"} -->
